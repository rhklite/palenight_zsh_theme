...
prompt_setup_richard(){
  ...
  base_prompt='%{$fg_bold[yellow]%}$(virtualenv_prompt_info)%{$reset_color%}%{$fg_bold[green]%}%n%{$reset_color%}%{$fg_bold[green]%}:%{$reset_color%}%{$fg_bold[blue]%}%(4~|.../%2~|%~)%{$reset_color%}%{$fg_bold[red]%} %{$reset_color%}'
